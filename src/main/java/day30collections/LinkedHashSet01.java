...
public class LinkedHashSet01 {
    /*
    LinkedHashSet ler elemanlari ekleme sirasina göre(insertion Order) yerleştirirler
    LinkedHashSet elemanlari siralamada zaman harcadıgı için HashSet'lere göre yavas calişir.
