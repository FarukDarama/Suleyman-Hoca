...
public class LinkedList01 {
    public static void main(String[] args) {
        ...
        String firstElement = names.poll();//ilk elementi verir sonra siler.pop dan farki eger list bos ise null veriyor exception vermez
        ...
        //Example 1: A ile baslayan tüm isimleri "*****" cevririniz
        ...
        //Example 2: List deki 4 harften fazla harf iceren isimleri siliniz
