...
public class Student {
    ...
    //protected olanlar baska package'lerden kullanilamaz ancak başka package' de "child class" içinden kullanılabilir.
    protected String address = "Miami";

    //default olanlar başka package dan kullanılmaz
    String email = "th@gmail.com";

    //Private olanlar sadece olusturuldukları class içinde kullanılırlar.
