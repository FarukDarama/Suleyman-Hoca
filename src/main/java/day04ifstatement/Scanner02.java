...
public class Scanner02 {
    ...
    Not: char variable'lari matematiksel islemlerde kullanirsaniz, Java onlarin ASCII degerlerini kullanir.
     ...
     Java "+" sembolu gorunce once toplama yapmaya calisir, yapamazsa birlestirme islemi yapmaya calisir, o da olmazsa
     hata verir.
    ...
    public static void main(String[] args) {
        ...
        char soyIlk = input.next().charAt(0);
        System.out.println(ilk+" "+soyIlk);*/
        //2. Yol
        System.out.println("Tam isminizi giriniz");
        String tamIsim=input.nextLine();
        char ilkHarf =tamIsim.charAt(0);
        char soyIsımIlkHarf = tamIsim.split(" ")[1].charAt(0);
        System.out.println(ilkHarf+" "+soyIsımIlkHarf);
